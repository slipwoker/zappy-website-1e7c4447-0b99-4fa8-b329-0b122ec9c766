    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .then(function(data) {
                    const successMessage = contactForm.querySelector('.form-success-message') || document.createElement('div');
                    if (!contactForm.querySelector('.form-success-message')) {
                        successMessage.className = 'form-success-message';
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; text-align: center; font-weight: 500;';
                ...
                .catch(function(error) {
                    const errorMessage = contactForm.querySelector('.form-error-message') || document.createElement('div');
                    if (!contactForm.querySelector('.form-error-message')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1e7c4447-0b99-4fa8-b329-0b122ec9c766',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1e7c4447-0b99-4fa8-b329-0b122ec9c766';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1e7c4447-0b99-4fa8-b329-0b122ec9c766';
